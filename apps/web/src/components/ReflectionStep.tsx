        ...
        <div className="space-y-12 animate-in slide-in-from-right-8 duration-500">
                ...
                {options.map((opt) => {
                    ...
                    return (
                        <button
                            ...
                            className={`flex flex-col items-center justify-center gap-4 p-8 rounded-3xl border-2 transition-all ${isSelected
            ...
            <div className="pt-8">
                <button
                    ...
                    className={`w-full py-5 rounded-2xl font-semibold flex items-center justify-center gap-2 transition-all ${selected
